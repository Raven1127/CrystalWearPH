...
if (isset($_GET['place'])) {
    ...
    while ($row_items = mysqli_fetch_array($run_items)) {
        ...
        while ($row_item = mysqli_fetch_array($run_item)) {
            ...
            $products .= $row_item['product_title']." ";
            $stock_total = $stock - $pro_qty;
            $total_q += $pro_qty;
            $pro_total_p = $pro_price * $pro_qty;
            $qry = "update products set stock='$stock_total' where products_id = $p_id";
    ...
    $order = "insert into orders (order_qty, order_price, product, order_size, c_id, date, status) values ('$total_q','$final_price','$products','$pro_size','$custom_id',NOW(),'Pending')";
